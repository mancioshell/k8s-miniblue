...
locals {
  ...
  keyvault_dataplane_url = get_env("KV_DATAPLANE", "http://localhost:4566")
...
inputs = {
  ...
  # Consumed by the key-vault unit to seed randomly-generated secrets into miniblue.
  keyvault_dataplane_url = local.keyvault_dataplane_url
}
